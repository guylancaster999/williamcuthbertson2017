...
print head("de","program","program.php","Y");
?>
<body>
<div data-role="page" id="pageone">
  <div data-role="header">
	...
	<table data-role="table" data-mode="columntoggle" class="ui-responsive">
		<tr><td colspan="3"><h1>2017</h1></td></tr>	
		<tr>
				<td >
					<b>Program 1</b>
				</td>
...
<tr><td><b>Program&nbsp;3<br/>(Violin &amp; Klavier)</b></td>
</tr>
<tr>
			 <td >WA Mozart</td>
			 <td>Sonate G-Dur KV.379</td>
			 </tr>
			 <tr>
				<td>PA Fiocco</td>
				<td>Allegro</td>
			 ...
			 <tr>
			 <td>H Wieniawski</td>
			 <td>Polonaise A-Dur Op.43</td>
					</tr>
			 <tr>
			 <td>P Sarasate</td>
			 <td>Introduktion und Tarantella</td>
			 </tr>
	...
	<table data-role="table" data-mode="columntoggle" class="ui-responsive">
		...
		<tr>		
		 	<tr>
				...
				<td rowspan="8">
					<img width="240" src="img/m.Grandpiano.jpg" alt="GrandPiano"/>
				</td>
			</tr>
			<tr> 
			 ...
			 <tr>
				...
				<th rowspan="10">
							<a href="http://www.lepthien.de/" title="Klavier Neumeyer">
								<img align="right" width="240" src="img/piano6.jpg" alt="Klavier Neumeyer">
							</a>
						</th>
					</tr>
 			<tr>
  			...
  			<tr>
				...
				<td date-priority="5" rowspan="14">
					<a title="#" title="Grand Piano">
						<img src="img/piano2.jpg" alt="Upright Piano" width="240" align="right">
					</a>
				</td>
			</tr>
			<tr>
				...
				<td  data-priority="1">Sonate B-Dur D 960</td>
				 <td data-priority="3" rowspan="2">
				  <a href="http://manonliuwinter.at/" title="Clavichord">
					<img src="img/m.clavichord1.jpg" alt="Clavichord" width="240" align="right"></a>
				 </td>
				</tr>
				<tr>
				<td data-priority="1">J.Brahms</td>
  			...
  			<tr>
				...
				<td rowspan='2' data-priority="3">
					<a href="#" title="Spinnet">
						<img align="right" src="img/m.spinett.jpg" alt="Spinnet" width="240"></a>
					</td>
				</tr>
				<tr>
