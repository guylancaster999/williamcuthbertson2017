<?php 
	require "funcz/m.functionz.php";
     print head("ch","音乐会","concert_ch.php","Y");
?>
...
function rwYr($yr)
{
	return '<tr><td colspan="3" class="year">'.$yr.'</td></tr>';
}
...
<div data-role="page" id="pageone"> 
  ...
  <main>
	  ...
	  <table  title="Konzerte" cellpadding="6">
 	  		<?php print rwYr('2017'); 
			 print rwEv("Friday 10th March 2017, 3 pm.",
			 "<B>Concert</B>",
			...
			print rwEv("Saturday 1st April",
				...
				'<ul>
				<li>Wolfgang Mozart Sonate G Major K.379</li>
				...
				print rwEv("Wed 1st November 2017","Piano Concert",
				...
				<li>Frédéric Chopin: 12 Préludes, op. 28</li>
					...
					Orgelbauersaal, Orgelstiftung, Gewerbekanal 1, Waldkirch, Baden-Württemberg. 
					 Voluntary Donation.',
				  	...
				  	print rwEv("Mon 20th November<br/>7pm","Thailand International Chopin Piano Competition : Concert",
			" <ul>
