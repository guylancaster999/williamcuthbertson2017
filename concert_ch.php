...
<div class="container">
  <div class="row">
    <div  <?php mnuClass();?>  >  
      ...
      <div <?php mainClass();?>>
		<?php print shead1("音乐会");?> 
            <main>
             <div class="row">
               <div class="col-12 col-sm-12 col-md-12  col-lg-12">
			       <?php print rwYr('2017');
				   print rwEv("Friday 10th March<br/>3 pm.",
						"Concert",
				...
				print rwEv("Sat 1st April, 7.30pm",
		             "Concert with William Cuthbertson (Piano) and Stephan Ronkov (Organ)",
					 '<ul>
						<li>F.Liszt Fantasy and  Fuge on the Choral "Ad nos, ad salutem undam" for Organ</li>
				...
				print rwEv('Sun 9th July <br/>11.00am',
				   ...
				   <li>Franz Schubert, Sonate A Major D664</li>	 
					...
					tickets 15&euro;, 13&euro; concession, 7&euro; children under 16
			...
			6.October  Freiburg<br/>
				...
				'Concert Season for the Old and Infirm with Ivetta Viatet, Violin(Russia)',
				...
				'2017violinpiano_240.JPG','Concert Season for the Old and Infirm with Ivetta Viatet (Russia), Violin');		
				 print rwEv("Sun 8th October<br/>5pm",
					...
					Schloßgasse 4, 79295 Sulzburg-Laufen,Markgräflerland, Baden-Württemberg,Germany.Tickets from &euro;20 - Buy <a href="https://www.reservix.de/tickets-bach-goldberg-variationen-william-cuthbertson-klavier-in-sulzburg-gutshof-guentert-am-8-10-2017/e1077188">here</a>.',
...
<li>Frédéric Chopin: 12 Préludes, op. 28</li>
 ...
 Donations welcome.	Orgelbauersaal, Gewerbekanal 1, Waldkirch, Baden-Württemberg, Germany.',
					...
					print rwEv("Sat 4th Nov<br/>7pm",
						...
						<li>Agnes Joshi-Meili<ul><li>J.Brahms, Intermezzo in A Minor, Op.76 No.7</li></ul></li>
						<li>Christian Loeschke<ul><li>J.Brahms, Intermezzo in E flat major Op.117 No.1 Intermezzo in B Minor Op.117 No.2</li></ul></li>
						<li>Agnes Joshi-Meili<ul><li>Genari Karganoff Op.10 No.1 Souvenir OP.10 No.2 Petite Valse</li></ul></li>
		...
		print rwEv("Mon 20th Nov<br/>7pm","Competition Concert",
			" <ul>
				<li>William Cuthbertson
					<UL><LI>F.Chopin: Barcarolle Op.60 </LI>
