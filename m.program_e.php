...
print head("en","program","program.php","Y");
?>
<body>
<div data-role="page" id="pageone">
	<div data-role="header">
		<?php print  top("en","Programme","Programme");?>
	</div>
			...
			<tr>
				...
				<TD ROWSPAN="10">
					<A HREF="http://bechstein.com/">
						<IMG SRC="img/klavier_240.jpg" alt="Bechstein Piano Repair" ALIGN="RIGHT" width="240">
					</A>
				</TD>
			</tr>
		<tr>
...
<tr><td><b>Program&nbsp;3<br/>(Violin &amp; Piano)</b></td>
</tr>
<tr>
			 <td >WA Mozart</td>
			 <td>Sonate G Major KV.379</td>
			 </tr>
			 <tr>
				<td>PA Fiocco</td>
				<td>Allegro</td>
			 ...
			 <tr>
			 <td>H Wieniawski</td>
			 <td>Polonaise A Major Op.43</td>
				</tr>
			 <tr>
			 <td>P Sarasate</td>
			 <td>Introduction and Tarantella</td>
			 </tr>
	</table>
</td>
</tr>
		...
		<tr>
     		<th colspan="2" data-priority="1"><h1>2016</h1></th>
				...
				<img src="img/m.spinett.jpg" alt="Spinnet" align="right" width="240"/>
			</td>
		...
		<tr>
				...
				<tr>
						...
						<tr>
							<td data-priority="1">Sergei Rachmaninov</td>
						...
						<td data-priority="1">G.Rossini</td>
							...
							<tr>
						<td data-priority="1">Franz Schubert</td>
						...
						<tr>
							<td data-priority="1">A.Schriabin</td>
			...
			<table data-role="table" data-mode="columntoggle" class="ui-responsive">
         	...
         	<img src="img/m.Grandpiano.jpg" alt="Grand Piano" width="240" align="right">
					</a>
				</td>
			</tr>	
 			<tr>
	...
	<tr>
		...
		<tr>
			<td data-priority="1">E.Granados </td>
		...
		<tr>
			<td data-priority="5"></td>
			<td data-priority="1">Etude Fis-Dur Op.42 Nr.4	</td>
		</tr>
		<tr>
			<td data-priority="5">&nbsp;</td>
			<td data-priority="1">Etude Cis-Moll Op.42 Nr.5</td>
		</tr>
		<tr>
			<td data-priority="5"></td>
			<td data-priority="1">Etude Des-Dur Op.42 Nr.6</td>
		</tr>
		<tr>
			<td data-priority="5">&nbsp;</td>
	...
	<table data-role="table" data-mode="columntoggle" class="ui-responsive">
		...
		<td rowspan="6" valign="top" data-priority="3">
				<a href="#" title="Piano">
					<img src="img/m.piano2014.jpg" alt="Piano" width="240" align="right">
				</a>
			</td>
		</tr>
		<tr>
		...
		<table data-role="table" data-mode="columntoggle" class="ui-responsive">
			<tr>
			<th colspan="3"	 data-priority="1"><h1>2013</h1></th>
		</tr>
		</table>
		<table data-role="table" data-mode="columntoggle" class="ui-responsive">
		<tr>
			...
			<td rowspan="2" data-priority="3">
				<a href="http://manonliuwinter.at/" title="Clavichord">
					<img src="img/m.clavichord1.jpg" alt="Clavichord" width="240" align="right">
				</a>
			</td>
		</tr>
		<tr>
		...
		<table data-role="table" data-mode="columntoggle" class="ui-responsive">
			...
			<td rowspan='4' data-priority="3">
				<a href="#" title="Spinnet">
					<img src="img/m.spinett.jpg" alt="Spinnet" width="240" align="right">
				</a>
			</td>
		</tr>
		<tr>
