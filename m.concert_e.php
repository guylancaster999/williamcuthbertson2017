<?php 
	require "funcz/m.functionz.php";
     print head("en","Concerts","concert_e.php","Y");
?>
...
<div data-role="page" id="pageone"> 
  ...
  <div data-role="header">
    <?php print top("en","Concerts","Concerts"); ?>
</div>
  </header>
  <main>
	  ...
	  <table  title="Konzerte" cellpadding="6">
			...
			print rwEv("Saturday 1st April",
				...
				'<ul><li>Wolfgang Mozart Sonate G Major K.379</li>
				...
				<li>Frédéric Chopin: 12 Préludes, op. 28</li>
				   ...
				   print rwEv("Sat 4th Nov, 7pm",
				  	...
				  	print rwEv("Mon 20th Nov<br/>7pm","Chopin international Piano Competition Concert",
			" <ul>
			...
			<li>Saori Haji
				...
				Siam Ratchada Auditorium, Yamaha Ratchadapisek Music School, Bangkok.",
				"siam.jpg");					  
