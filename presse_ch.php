<?php
	...
	print head("ch","报纸","presse_ch.php");
?> 
<body>
 <div class="container">
  <div class="row">
    <div  <?php mnuClass();?> >  
		<?php print menu("ch","报纸","presse_e.php","presse.php","presse_ch.php");?>
	</div>	  
     <div  <?php mainClass();?>>
		<?php print shead1("报纸");?>   
		   <main>
		   ...
		   <article>
			 <?php photoright("KonzertJul17.jpg","KonzertJul17_240.jpg","Press","Concert July 2017","presse_ch.php","ch");?>
			<h3>Brillant Summer Matinee</h3>
Virtuoso Pianist William Cuthbertson plays stylishly from the Baroque to the Modern.
<br/>
<br/>
<a href="http://www.badische-zeitung.de/waldkirch/brillante-sommer-matinee--139311437.html">Badische Zeitung, July 2017</a>
	  <br  class="brclear" />
	<hr/>
	</article>
   <article>
 			   <?php photoright("Fr08Juli2016.jpg","Fr08Juli2016_240.jpg","Press","Chopin Schuman Beethoven, Foto: G. Zahn","presse_e.php","de");?>
	...
	<hr/>
	 ...
	 <article>
			...
			<?php photoright("peter.feuchtwanger_teaching.jpg","peterfeuchwanger-photo-badishezeitung_240.jpg","Presse","Peter%20Feuchtwanger:Photo%20Karig","presse.php","de" );?>
				...
				"William%20Cuthbertson spielt Chopin Etuden:Foto Badische%20Zeitung","presse.php","de");?> 
<br  class="brclear" />	 </article>
	 <article>
	 ...
	 <article>
			 	...
			 	<?php photoright("williamandweimo.jpg","williamandweimo_240.jpg","Presse", 
				"William%20Cuthbertson%20und%20Weimo%20Gao:Foto%20Hildegard%20Karig,%20Badische%20Zeitung","presse.php","de");?> 
				William Cuthbertson und Weimo Gao bringen in Waldkirch Altmeister Bach zu Gehör &ndash; aber auch ein chinesisches Wiegenlied. 
				<ul>
					<li>Tänzerische Leichtigkeit und elegische Momente William Cuthbertson und Weimo Gao bringen in Waldkirch Altmeister Bach zu Gehör &ndash; aber auch ein chinesisches Wiegenlied.</li>
				</ul> 
...
<br  class="brclear" />				
	 ...
	 <article>
    			<h3><strong>Spannende Klangwelten - Sun Yiqi (Violine) und William Cuthbertson (Klavier) im Torhaus. 2012.</strong></h3>
						...
						<br/>
						William Cuthbertson ist Konzertpianist und Klavierlehrer, lebt in Waldkirch und gilt als Meister der Improvisation.<br/> 
						<a href="http://www.badische-zeitung.de/herbolzheim/spannende-klangwelten--61832808.html">Badische zeitung</a>.
						<br class="brclear" />
						<hr/>
	 </article>
	 <article>
    					<h3>Feuchtwanger Pianofestival 2010</h3>
						Fränkische Landeszeitung 12.4.2010
						<ul>
						<li>"Brite bewältigt technische Hürden mit lässiger Eliganz"		</li>
						<li>"Im Spannungsfels von herzzerreißender Tragik und höfischem Aplomb malt der fast zu kontrolliert, zu reserviert agierende Engländer plastische Seelengemälde in gedeckte Farben."
						</li>
						<li>"In den zwölf Etüden Opus 25 arbeitet Cuthbertson mit scharfen Kontrasten und erreicht damit eine dramatische Dichte, die ihresgleichen sucht."
						</li>
						</ul><br  class="brclear" />
						<HR/>
	 </article>
	 <article>
    					<h3>Chopin Zyklus Waldkirch 2010</h3>
						Elztäler Wochenbericht 11.3 2010
						<ul>
						<li>"Virtuos meistert Cuthbertson die technischen Anforderungen von Chopin, sein lyrisches Klavierspiel machen die Scherzi und Balladen zum höchsten Genuss."
						</li>
						</ul>
						Badische Zeitung 4.3.2010
     					<ul>
						<li>"Leichthändig und doch ausgelotet"
						</li>
						<li>"Cuthbertsons Spiel zeugt von höchstem technisch-virtuosem Können und Brillanz und ist dabei absolut frei und überaus nuancenreich in derDarstellung. Eine Meisterschaft des  musikalischen Ausdrucks, wie sie wohl nur durch eine ebenslange Beschäftigung mit Chopin möglich ist."
						</li>
						</ul>
						Badische Zeitung 15.4.2010
    					<ul>
						<li>"Kongeniale Interpretation Chopinscher Etuden"</li>
						<li>(Op.10 Nr.3 ) "Cuthbertson spielte sie mit einem wunderbar warmblütigen, dabei aber auch klaren, reine Klang."
						</li>
						<li>(Op.25 Nr 9) "Elegant perlend wie Champagne"
						</li>
						<li>(Op.25 Nr 11) "dessen äußerst stürmische Böen Cuthbertson wieselflink und markellos in Szene setzte"
						</li>
						<li>(Op.25 Nr.12) " stürmisch und getrieben von brachialer Naturgewalt"</li>
						</ul>
						Badische Zeitung 23.9.2010
    					<ul>
						<li>"William Cuthbertson spielte .. technisch ausgereift bis zur Perfektion, meisterte auch die halsbrecherischsten Läufe mit gelassener Souveränität und gab dem tief empfindenen Melos Chopins genugend Raum zur Entfaltung."
						</li>
						<li>"mit virtuoser Fingerakrobatik meisterhaft berherrscht"
						</li>
						</ul>
						Badische Zeitung 12.10 2010
    					<ul>
						<li>"Es ist kaum in Worte zu fassen, was die Ohren hörten und welche Gefühle Cuthbertson mit seinem Spiel bei den Zuhörern auslöste. "
						</li>
						</ul>
						Badische Zeitung 20.11.2010
    					<ul>
						<li>"Cuthbertson verstand es mit großer Meisterschaft, jede Nuance dieser Gefühlsschwankungen eindrücklich nachzuzeichnen."
						</li>
						<li>"Das überwältigende Epos bewältigte Cuthbertson souverän und scheinbar mühelos  "
						</li>
						<li>"Der außergewöhnliche Künstler wurde mit anhaltendem Beifall und Bravorufen verabschiedet. "</li>
	  </article>
        		</main>
		        </div>
		</div>
