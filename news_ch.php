...
{
	echo dophotorightnolink($pic,$ttl);
	echo '<article><h3><b>'.$ttl.'</b></h3>'.$txt.'</article>
			<br class="brclear"/><hr>';
	return;
}
print head("ch","新闻","",",Thai, Juror, Competion, Judge");
 ?>
<body> 
<div class="container">
  <div class="row">	
    <div class="col-sm-2 col-md-2 col-lg-2" >  
			<?php 
			print menu("ch","新闻",'news_e.php','news.php','news_ch.php');
			?>
	 </div>	  
      <div class="col-sm-10   col-md-10 col-lg-10">
		...
		<?php newsitem("Gisela Sick Education Centre, Waldkirch",
...
newsitem("Thailand 4th International Chopin Competition",
		...
		</ul>", "thaichopincompetition_240.jpg");
