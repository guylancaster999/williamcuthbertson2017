...
function rwEv($dt,$ttl,$ev,$photo="",$photottl="",$photolink="")
{
	$ret='<article>
			<div class="row">
              <div class="col-lg-3 col-md-3 col-sm-3 boldTxt">'.$dt.'</div>
 ...
 <div class="container">
  <div class="row">
    <div <?php mnuClass();?>>  
      ...
      <div <?php mainClass();?>>
		<?php print shead1("Concerts");?>       
	 		   <main>
             <div class="row">
               <div class="col-12 col-sm-12 col-md-12  col-lg-12">
			       <?php print rwYr('2017');?>
		 <?php print rwEv("Fri 10th March<br/>3 pm",
						"Concert",
		     ...
		     print rwEv("Sat 1st April<br/>7.30pm",
		             "Concert with William Cuthbertson (Piano) and Stephan Ronkov (Organ)",
					 '<ul>
						<li>F.Liszt Fantasy and Fugue on the Choral "Ad nos, ad salutem undam" for Organ</li>
						<li>F.Liszt Sonata in B Minor for Piano</li>
						<li>W Cuthbertson, Fantasy on the Gregorian chorale &quot;Videns dominus...Lazare veni foras&quot; for organ and piano</li>
					</ul>
					Collection.
			...
			print rwEv("Fri 28th April<br/>7.30pm",
							"Pleasure journey in the time of Sturm und Drang and the Weimar Classic",
							'<ul>
							<li>Peter M. Ritter recites well-known and popular texts and poems by Johann Wolfgang von Goethe</li>
							<li>William Cuthbertson plays the Grand Sonata Pathetique Op.13 by Ludwig van Beethoven.</li>
							</ul>',
							"ritter_240.jpg","Peter M. Ritter");
			print rwEv('Sun 9th July <br/>11.00am',
		            'Piano Matinée',
					'<ul>
				   <li>Johann Sebastian Bach&nbsp;Partita C Minor BWV826</li>
				   <li>Franz Schubert, Sonate A Major D664</li>	 
					<li>Maurice Ravel, Pavane pur une infante défunte, Valses nobles et sentimentales,  Albordo del Gracioso</li>
				 </ul> tickets 15€, 13€ concession, 7€ children under 16.
			  <a href="http://p23515.typo3server.info/29.0.html">Elztalmuseum</a>, Waldkirch, Germany',
			...
			print rwEv("Sun 8th October<br/>5pm",
				 ...
				 Tickets from &euro;20 - Buy <a href="https://www.reservix.de/tickets-bach-goldberg-variationen-william-cuthbertson-klavier-in-sulzburg-gutshof-guentert-am-8-10-2017/e1077188">here</a>.',
				...
				print rwEv("Wed 1st Nov, 7pm",
					 ...
					 Donations welcome.	Orgelbauersaal, Gewerbekanal 1, Waldkirch, Baden-Württemberg, Germany.	',
					  "EkaterineKhvedelidze_240.jpg",
					  "Ekaterine Khvedelidze",
					  "http://www.ekaterine.de"); 
			    print rwEv("Sat 4th Nov, 7pm",
						"Masterclass Participants  Concert",
						'<Ul>
						<li>Rosmarie Schmidt <ul><li>W.A.Mozart, Sonata in C major K.279 First movement, Allegro</li></ul> </li>
						<li>Agnes Joshi-Meili<ul><li>J.Brahms, Intermezzo in A Minor, Op.76 No.7</li>
						<li>Genari Karganoff Op.10 No.1 Souvenir OP.10 No.2 Petite Valse</li> 
						</ul></li>
						<li>Christian Loeschke<ul><li>J.Brahms, Intermezzo in E flat major Op.117 No.1 Intermezzo in B Minor Op.117 No.2</li></ul></li>
						<li>Saeko Saito <ul><li>R.Schumann, Scherzo Op.32 No.1</li><li>F.Chopin Étude Ges Major Op.10 No.5</li> </ul></li>
						<li>Robbert van Steijn<ul><li>F.Liszt, Sonnetto di Petrarca 104</li><li>F.Chopin, Ballad in F Minor Op.52</li></ul></li></Ul>Donations welcome.	Orgelbauersaal, Orgelstiftung, Gewerbekanal 1, Waldkirch, Baden-Württemberg, Germany.',
					  "2017mcp2",
					  "Closing concert",
					  "http://www.waldkircher-orgelstiftung.de/"); 
			print rwEv("Mon 20th Nov<br/>7pm",
			...
			<li>Saori Haji
				...
				print rwEv("Fri 11th March",
					...
					print rwEv("Sun July 3rd<br/>11am",
			...
			print rwEv('Wed 31st August<br/>7.30pm',
			...
			<LI> E.Granados - Andaluza and Allegro de Concerto - <a href="https://www.facebook.com/emma.stratton.39"> Emma Stratton</a></LI>
					 ...
					 print rwYr(2015);
					 print rwEv('Fri 13th March<br/>8.30pm ',
				   ...
				   'Concert',
				 	...
				 	print rwEv('Sun 19th April <br/>11am',
						'Concert',
						'including:<ul>
				   ...
				   'The musician Alexander Scriabin (1871-1915) Concert and lecture',
					...
					<br/>
						Entry 3&euro;');
					print rwEv('Sun 25th October <br/>11am',
					'The musician Alexander Scriabin (1871-1915) Concert and lecture',
					'Catholic community center , Church Square 7, Waldkirch. 
					At the Piano: William Cuthberson, Waldkirch. 
						Concert including:
					...
					print rwEv('Thu 30th January<br/>8pm',
					...
					print rwEv('Sun 13th July<br/>11am',
					...
					print rwEv('Sun 20th July<br/> 2pm',
					...
					print rwEv(' Mon 21st July<br />8pm',
				...
				Islay Gaelic Centre (Ionad Chaluim Chille Ìle), 
					 ...
					 print rwEv(' July','Concert',
						...
						Germany');
					 print rwEv('28th	September <br/> 29th September<br/>5pm',
						'Piano recital',
						'<ul>
					...
					print rwEv('10th October <br/>8pm',
					...
					print rwEv('12th October  <br/> 7pm',
					...
					<li>Works by Brahms, Franck, Cuthbertson and Middleton.</li>
					 ...
					 print rwEv('5th Oktober, 8pm,',
					 'Waldirch Culture Week ',
					 'William Cuthbertson (Piano) und his sister Fiona Middleton (Violin/Voice) 
					perform works by  Bach, Dvorak, Franck.  Orgelbauersaal, Gewerbekanal 1. 
